...
public class NodePositionList1<T> implements PositionList<T> {
	private DNode<T> header, trailer; 
	private int count; 
	PositionListIteratorMaker<T>  iteratorMaker;
	
	public NodePositionList1() {
	...
	public NodePositionList1(PositionListIteratorMaker<T> iteratorChoice){
		this();
		this.iteratorMaker = iteratorChoice;
	...
	private static class DNode<T2> implements Position<T2> {
        ...
        private NodePositionList1<T2> myList;     // list it belongs to
        
        public DNode(T2 e, DNode<T2> p, DNode<T2> n, NodePositionList1<T2> list) { 
        	element = e; 
        	next = n; 
        	prev = p; 
        	myList = list; 
		...
		public void setList(NodePositionList1<T2> n) { 
			myList = n; 
		}
		public NodePositionList1<T2> getList() { 
			return myList; 
		}
